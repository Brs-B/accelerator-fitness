...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./utils/slider":15,"./utils/swiper-bundle.esm.browser.min.js":16,"./utils/tabs":17}],2:[function(require,module,exports){
"use strict";
  ...
  s({
    ...
    if (t.params.observer) {
      if (t.params.observeParents) {
        var _e3 = elementParents(t.el);
        for (var _t2 = 0; _t2 < _e3.length; _t2 += 1) l(_e3[_t2]);
      }
      l(t.el, {
...
function updateSlides() {
  ...
  for (var _i2 = 0; _i2 < u; _i2 += 1) {
    var _r2 = void 0;
    if (M = 0, p[_i2] && (_r2 = p[_i2]), T && e.grid.updateSlide(_i2, _r2, u, t), !p[_i2] || "none" !== elementStyle(_r2, "display")) {
      if ("auto" === a.slidesPerView) {
        C && (p[_i2].style[t("width")] = "");
        var _n2 = getComputedStyle(_r2),
          _l = _r2.style.transform,
          _o = _r2.style.webkitTransform;
        if (_l && (_r2.style.transform = "none"), _o && (_r2.style.webkitTransform = "none"), a.roundLengths) M = e.isHorizontal() ? elementOuterSize(_r2, "width", !0) : elementOuterSize(_r2, "height", !0);else {
          var _e4 = s(_n2, "width"),
            _t3 = s(_n2, "padding-left"),
            _a = s(_n2, "padding-right"),
            _i3 = s(_n2, "margin-left"),
            _l2 = s(_n2, "margin-right"),
            _o2 = _n2.getPropertyValue("box-sizing");
          if (_o2 && "border-box" === _o2) M = _e4 + _i3 + _l2;else {
            var _r3 = _r2,
              _s3 = _r3.clientWidth,
              _n3 = _r3.offsetWidth;
            M = _e4 + _t3 + _a + _i3 + _l2 + (_n3 - _s3);
          }
        }
        _l && (_r2.style.transform = _l), _o && (_r2.style.webkitTransform = _o), a.roundLengths && (M = Math.floor(M));
  ...
  if (d && a.loop) {
    ...
    if (a.slidesPerGroup > 1) {
      ...
      for (var _e5 = 0; _e5 < _s5; _e5 += 1) m.push(m[m.length - 1] + _i5);
    }
...
function updateAutoHeight(e) {
  ...
  if ("auto" !== t.params.slidesPerView && t.params.slidesPerView > 1) {
    if (t.params.centeredSlides) (t.visibleSlides || []).forEach(function (e) {
      ...
      if (_e8 > t.slides.length && !a) break;
      s.push(n(_e8));
    }
  } else s.push(n(t.activeIndex));
  for (i = 0; i < s.length; i += 1) if (void 0 !== s[i]) {
    var _e9 = s[i].offsetHeight;
    r = _e9 > r ? _e9 : r;
  }
...
function updateSlidesProgress(e) {
  ...
  for (var _e10 = 0; _e10 < a.length; _e10 += 1) {
    var o = a[_e10];
    ...
    var c = (n + (s.centeredSlides ? t.minTranslate() : 0) - d) / (o.swiperSlideSize + l),
      ...
      u = -(n - d),
      m = u + t.slidesSizesGrid[_e10];
    (u >= 0 && u < t.size - 1 || m > 1 && m <= t.size || u <= 0 && m >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(_e10), a[_e10].classList.add(s.slideVisibleClass)), o.progress = i ? -c : c, o.originalProgress = i ? -p : p;
  }
}
function updateProgress(e) {
  ...
  if (s.loop) {
    var _s12 = t.getSlideIndexByData(0),
      ...
      _r4 = t.slidesGrid[_a2],
      _n4 = t.slidesGrid[t.slidesGrid.length - 1],
      _o3 = Math.abs(e);
    l = _o3 >= _i6 ? (_o3 - _i6) / _n4 : (_o3 + _n4 - _r4) / _n4, l > 1 && (l -= 1);
  }
  Object.assign(t, {
    progress: i,
    progressLoop: l,
...
function updateSlidesClasses() {
  ...
  if (l) {
    ...
    var _e11 = elementNextAll(l, ".".concat(s.slideClass, ", swiper-slide"))[0];
    s.loop && !_e11 && (_e11 = t[0]), _e11 && _e11.classList.add(s.slideNextClass);
...
function getActiveIndexByTranslate(e) {
  ...
  var i;
  for (var _e12 = 0; _e12 < t.length; _e12 += 1) void 0 !== t[_e12 + 1] ? a >= t[_e12] && a < t[_e12 + 1] - (t[_e12 + 1] - t[_e12]) / 2 ? i = _e12 : a >= t[_e12] && a < t[_e12 + 1] && (i = _e12 + 1) : a >= t[_e12] && (i = _e12);
...
function updateActiveIndex(e) {
  ...
  if (void 0 === d && (d = getActiveIndexByTranslate(t)), a.indexOf(s) >= 0) o = a.indexOf(s);else {
    var _e13 = Math.min(i.slidesPerGroupSkip, d);
    o = _e13 + Math.floor((d - _e13) / i.slidesPerGroup);
  }
...
function updateClickedSlide(e) {
  ...
  var i,
    r = !1;
  if (a) for (var _e14 = 0; _e14 < t.slides.length; _e14 += 1) if (t.slides[_e14] === a) {
    r = !0, i = _e14;
    break;
  }
...
function slideTo(e, t, s, a, i) {
  ...
  if (l.normalizeSlideIndex) for (var _e16 = 0; _e16 < d.length; _e16 += 1) {
    var _t13 = -Math.floor(100 * v),
      _s13 = Math.floor(100 * d[_e16]),
      _a6 = Math.floor(100 * d[_e16 + 1]);
    void 0 !== d[_e16 + 1] ? _t13 >= _s13 && _t13 < _a6 - (_a6 - _s13) / 2 ? n = _e16 : _t13 >= _s13 && _t13 < _a6 && (n = _e16 + 1) : _t13 >= _s13 && (n = _e16);
  }
  ...
  if (l.cssMode) {
    ...
    if (0 === t) {
      ...
      _t14 && (r.wrapperEl.style.scrollSnapType = "none", r._immediateVirtual = !0), _t14 && !r._cssModeVirtualInitialSet && r.params.initialSlide > 0 ? (r._cssModeVirtualInitialSet = !0, requestAnimationFrame(function () {
        m[_e17 ? "scrollLeft" : "scrollTop"] = _s14;
      })) : m[_e17 ? "scrollLeft" : "scrollTop"] = _s14, _t14 && requestAnimationFrame(function () {
      ...
      m.scrollTo((_m$scrollTo = {}, _defineProperty(_m$scrollTo, _e17 ? "left" : "top", _s14), _defineProperty(_m$scrollTo, "behavior", "smooth"), _m$scrollTo));
    }
    return !0;
  }
...
function slidePrev(e, t, s) {
  ...
  if (void 0 === f && i.cssMode) {
    ...
    r.forEach(function (t, s) {
      u >= t && (_e18 = s);
    }), void 0 !== _e18 && (f = r[_e18 > 0 ? _e18 - 1 : _e18]);
  }
  var h = 0;
...
function slideToClosest(e, t, s, a) {
  ...
  if (o >= i.snapGrid[l]) {
    var _e19 = i.snapGrid[l];
    o - _e19 > (i.snapGrid[l + 1] - _e19) * a && (r += i.params.slidesPerGroup);
  } else {
    var _e20 = i.snapGrid[l - 1];
    o - _e20 <= (i.snapGrid[l] - _e20) * a && (r -= i.params.slidesPerGroup);
  }
...
function loopFix(e) {
  ...
  if (r < h) {
    ...
    for (var _e21 = 0; _e21 < h - r; _e21 += 1) {
    ...
    for (var _e22 = 0; _e22 < S; _e22 += 1) {
      var _t16 = _e22 - Math.floor(_e22 / d.length) * d.length;
      v.push(_t16);
    }
  }
  if (y && g.forEach(function (e) {
    ...
    var _e24 = o.slidesGrid[w],
      _t18 = o.slidesGrid[w - S] - _e24;
  ...
  if (o.allowSlidePrev = c, o.allowSlideNext = p, o.controller && o.controller.control && !n) {
    ...
    Array.isArray(o.controller.control) ? o.controller.control.forEach(function (t) {
      !t.destroyed && t.params.loop && t.loopFix(_e25);
    }) : o.controller.control instanceof o.constructor && o.controller.control.params.loop && o.controller.control.loopFix(_e25);
  }
  o.emit("loopFix");
}
...
function onTouchMove(e) {
  ...
  if (void 0 === a.isScrolling) {
    var _e26;
    s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? a.isScrolling = !1 : m * m + f * f >= 25 && (_e26 = 180 * Math.atan2(Math.abs(f), Math.abs(m)) / Math.PI, a.isScrolling = s.isHorizontal() ? _e26 > i.touchAngle : 90 - _e26 > i.touchAngle);
  }
  ...
  if (!a.isMoved) {
    if (w && s.loopFix({
      ...
      var _e27 = new window.CustomEvent("transitionend", {
        bubbles: !0,
        cancelable: !0
      });
      s.wrapperEl.dispatchEvent(_e27);
    }
...
function onTouchEnd(e) {
  ...
  if (t.allowClick) {
    var _e28 = d.path || d.composedPath && d.composedPath();
    t.updateClickedSlide(_e28 && _e28[0] || d.target), t.emit("tap click", d), p < 300 && c - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", d);
  }
  ...
  for (var _e29 = 0; _e29 < l.length; _e29 += _e29 < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
    var _t19 = _e29 < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
    void 0 !== l[_e29 + _t19] ? u >= l[_e29] && u < l[_e29 + _t19] && (m = _e29, f = l[_e29 + _t19] - l[_e29]) : u >= l[_e29] && (m = _e29, f = l[l.length - 1] - l[l.length - 2]);
  }
  var h = null,
    g = null;
...
function getBreakpoint(e, t, s) {
  ...
  for (var _e30 = 0; _e30 < n.length; _e30 += 1) {
    var _n$_e = n[_e30],
      _r5 = _n$_e.point,
      l = _n$_e.value;
    "window" === t ? i.matchMedia("(min-width: ".concat(l, "px)")).matches && (a = _r5) : l <= s.clientWidth && (a = _r5);
  }
  return a || "max";
}
var breakpoints = {
  ...
  _createClass(Swiper, [{
    ...
    value: function slidesPerViewDynamic(e, t) {
      ...
      if (s.centeredSlides) {
        ...
        for (var _s16 = l + 1; _s16 < a.length; _s16 += 1) a[_s16] && !_e32 && (_t22 += a[_s16].swiperSlideSize, o += 1, _t22 > n && (_e32 = !0));
        for (var _s17 = l - 1; _s17 >= 0; _s17 -= 1) a[_s17] && !_e32 && (_t22 += a[_s17].swiperSlideSize, o += 1, _t22 > n && (_e32 = !0));
      } else if ("current" === e) for (var _e33 = l + 1; _e33 < a.length; _e33 += 1) {
        (t ? i[_e33] + r[_e33] - i[l] < n : i[_e33] - i[l] < n) && (o += 1);
      } else for (var _e34 = l - 1; _e34 >= 0; _e34 -= 1) {
        i[l] - i[_e34] < n && (o += 1);
      }
      return o;
    }
...
exports.default = exports.Swiper = Swiper;
function Virtual(e) {
  var t,
    s = e.swiper,
    a = e.extendParams,
  ...
  function d(e) {
    ...
    if (e) s.slidesEl.querySelectorAll(".".concat(s.params.slideClass, ", swiper-slide")).forEach(function (e) {
      e.remove();
    });else for (var _e35 = c; _e35 <= p; _e35 += 1) if (_e35 < b || _e35 > y) {
      var _t25 = M(_e35);
    ...
    }), n) for (var _e36 = x.length - 1; _e36 >= 0; _e36 -= 1) {
      var _t27 = x[_e36];
  ...
  i("beforeInit", function () {
    ...
    prependSlide: function prependSlide(e) {
      ...
      if (s.params.virtual.cache) {
        var _e37 = s.virtual.cache,
          _t31 = {};
        Object.keys(_e37).forEach(function (s) {
          var a = _e37[s],
    ...
    if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || r.activeElement && r.activeElement.nodeName && ("input" === r.activeElement.nodeName.toLowerCase() || "textarea" === r.activeElement.nodeName.toLowerCase()))) {
      if (t.params.keyboard.onlyInViewport && (d || c || p || u || m || f)) {
        ...
        var _a10 = t.el,
          ...
          _r6 = _a10.clientHeight,
          _l4 = n.innerWidth,
          _o4 = n.innerHeight,
          _d2 = elementOffset(_a10);
        s && (_d2.left -= _a10.scrollLeft);
        var _c = [[_d2.left, _d2.top], [_d2.left + _i8, _d2.top], [_d2.left, _d2.top + _r6], [_d2.left + _i8, _d2.top + _r6]];
  ...
  function m(e) {
    ...
    if (h >= t.minTranslate() && (h = t.minTranslate()), h <= t.maxTranslate() && (h = t.maxTranslate()), a = !!t.params.loop || !(h === t.minTranslate() || h === t.maxTranslate()), a && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
      var _e39 = {
        ...
        _a11 = l && _e39.time < l.time + 500 && _e39.delta <= l.delta && _e39.direction === l.direction;
      if (!_a11) {
        l = void 0;
        ...
        if (_o5 >= t.minTranslate() && (_o5 = t.minTranslate()), _o5 <= t.maxTranslate() && (_o5 = t.maxTranslate()), t.setTransition(0), t.setTranslate(_o5), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!_c2 && t.isBeginning || !_u && t.isEnd) && t.updateSlidesClasses(), t.params.loop && t.loopFix({
          direction: _e39.direction < 0 ? "next" : "prev",
          byMousewheel: !0
        }), t.params.freeMode.sticky) {
          clearTimeout(n), n = void 0, d.length >= 15 && d.shift();
          var _s20 = d.length ? d[d.length - 1] : void 0,
            _a12 = d[0];
          if (d.push(_e39), _s20 && (_e39.delta > _s20.delta || _e39.direction !== _s20.direction)) d.splice(0);else if (d.length >= 15 && _e39.time - _a12.time < 500 && _a12.delta - _e39.delta >= 1 && _e39.delta <= 6) {
            var _s21 = p > 0 ? .8 : .2;
            l = _e39, d.splice(0), n = nextTick(function () {
              t.slideToClosest(t.params.speed, !0, void 0, _s21);
            }, 0);
          }
          n || (n = nextTick(function () {
            l = _e39, d.splice(0), t.slideToClosest(t.params.speed, !0, void 0, .5);
          }, 500));
        }
...
function Navigation(e) {
  ...
  a("init", function () {
    ...
    if (t.params.navigation.hideOnClick && !n.includes(l) && !a.includes(l)) {
      ...
      var _e40;
      a.length ? _e40 = a[0].classList.contains(t.params.navigation.hiddenClass) : n.length && (_e40 = n[0].classList.contains(t.params.navigation.hiddenClass)), i(!0 === _e40 ? "navigationShow" : "navigationHide"), [].concat(_toConsumableArray(a), _toConsumableArray(n)).filter(function (e) {
        return !!e;
      }).forEach(function (e) {
...
function Pagination(e) {
  ...
  function p(e) {
    ...
    if (t.params.loop) {
      ...
      var _e41 = t.getSlideIndexByData(a),
        _s23 = t.getSlideIndexByData(t.realIndex);
      _e41 > t.slides.length - t.loopedSlides && t.loopFix({
        direction: _e41 > _s23 ? "next" : "prev",
        activeSlideIndex: _e41,
        slideTo: !1
      }), t.slideToLoop(a);
    } else t.slideTo(a);
  }
  function u() {
    ...
    if (t.params.loop ? (r = t.previousRealIndex || 0, a = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (a = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, a = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
      ...
      if (s.dynamicBullets && (n = elementOuterSize(_i9[0], t.isHorizontal() ? "width" : "height", !0), p.forEach(function (e) {
      ...
      }), s.dynamicMainBullets > 1 && void 0 !== r && (l += a - (r || 0), l > s.dynamicMainBullets - 1 ? l = s.dynamicMainBullets - 1 : l < 0 && (l = 0)), _o6 = Math.max(a - l, 0), _d3 = _o6 + (Math.min(_i9.length, s.dynamicMainBullets) - 1), _u2 = (_d3 + _o6) / 2), _i9.forEach(function (e) {
        var _e$classList4;
        ...
        var _e42$classList;
        var _e42 = _i9[a];
        if (_e42 && (_e42$classList = _e42.classList).add.apply(_e42$classList, _toConsumableArray(s.bulletActiveClass.split(" "))), s.dynamicBullets) {
          var _e43 = _i9[_o6],
            _t33 = _i9[_d3];
          for (var _e44 = _o6; _e44 <= _d3; _e44 += 1) {
            var _i9$_e44$classList;
            _i9[_e44] && (_i9$_e44$classList = _i9[_e44].classList).add.apply(_i9$_e44$classList, _toConsumableArray("".concat(s.bulletActiveClass, "-main").split(" ")));
          }
          c(_e43, "prev"), c(_t33, "next");
        }
      }
      if (s.dynamicBullets) {
        var _a14 = Math.min(_i9.length, s.dynamicMainBullets + 4),
          _r7 = (n * _a14 - n) / 2 - _u2 * n,
          _l5 = e ? "right" : "left";
        _i9.forEach(function (e) {
          e.style[t.isHorizontal() ? _l5 : "top"] = "".concat(_r7, "px");
        });
      }
    }
    p.forEach(function (e, r) {
      if ("fraction" === s.type && (e.querySelectorAll(classesToSelector(s.currentClass)).forEach(function (e) {
        ...
        var _n5 = 1,
          _l6 = 1;
        "horizontal" === _i10 ? _n5 = _r8 : _l6 = _r8, e.querySelectorAll(classesToSelector(s.progressbarFillClass)).forEach(function (e) {
          e.style.transform = "translate3d(0,0,0) scaleX(".concat(_n5, ") scaleY(").concat(_l6, ")"), e.style.transitionDuration = "".concat(t.params.speed, "ms");
        });
      }
  ...
  a("changeDirection", function () {
    ...
    if (Array.isArray(r) || (r = [r].filter(function (e) {
      ...
      var _e45 = r[0].classList.contains(t.params.pagination.hiddenClass);
      i(!0 === _e45 ? "paginationShow" : "paginationHide"), r.forEach(function (e) {
...
function Zoom(e) {
    ...
    if (n = !1, l = !1, c.push(e), !(c.length < 2)) {
      ...
      if (p.imageEl) {
        var _ref3 = function () {
          ...
          _e46 = _ref4[0],
          _t35 = _ref4[1];
        p.originX = _e46, p.originY = _t35, p.imageEl.style.transitionDuration = "0ms";
      }
      d = !0;
    }
  }
  ...
  function x() {
    ...
    if (!p.slideEl) {
      ...
      var _e47 = p.slideEl.querySelector(".".concat(s.containerClass));
      _e47 && (_e47 = _e47.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), p.imageEl = _e47, p.imageWrapEl = _e47 ? elementParents(p.imageEl, ".".concat(s.containerClass))[0] : void 0;
    }
...
function Controller(e) {
  ...
  s({
    ...
    if ("undefined" != typeof window && ("string" == typeof t.params.controller.control || t.params.controller.control instanceof HTMLElement)) {
      var _e48 = document.querySelector(t.params.controller.control);
      if (_e48 && _e48.swiper) t.controller.control = _e48.swiper;else if (_e48) {
        var _s27 = function _s27(a) {
          t.controller.control = a.detail[0], t.update(), _e48.removeEventListener("init", _s27);
        };
        _e48.addEventListener("init", _s27);
      }
    ...
    setTranslate: function setTranslate(e, s) {
      ...
      if (Array.isArray(a)) for (var _e49 = 0; _e49 < a.length; _e49 += 1) a[_e49] !== s && a[_e49] instanceof l && o(a[_e49]);else a instanceof l && s !== a && o(a);
    },
...
function History(e) {
  ...
  var n = function n(e) {
    ...
    d = function d(e, s, a) {
      if (s) for (var _i11 = 0, _r9 = t.slides.length; _i11 < _r9; _i11 += 1) {
        var _r10 = t.slides[_i11];
        if (n(_r10.getAttribute("data-history")) === s) {
          var _s29 = t.getSlideIndex(_r10);
          t.slideTo(_s29, e, a);
        }
    ...
    hashNavigation: {
      ...
      getSlideIndex: function getSlideIndex(e, s) {
        if (t.virtual && t.params.virtual.enabled) {
          var _e50 = t.slides.filter(function (e) {
            return e.getAttribute("data-hash") === s;
          })[0];
          if (!_e50) return 0;
          return parseInt(_e50.getAttribute("data-swiper-slide-index"), 10);
        }
...
function Thumb(e) {
  ...
  function o(e) {
    ...
    }), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (var _e51 = 0; _e51 < i; _e51 += 1) elementChildren(s.slidesEl, "[data-swiper-slide-index=\"".concat(t.realIndex + _e51, "\"]")).forEach(function (e) {
      e.classList.add(r);
    });else for (var _e52 = 0; _e52 < i; _e52 += 1) s.slides[t.realIndex + _e52] && s.slides[t.realIndex + _e52].classList.add(r);
    ...
    if (t.realIndex !== s.realIndex || l) {
      ...
      var _r11, _o7;
      if (s.params.loop) {
        var _e53 = s.slides.filter(function (e) {
          return e.getAttribute("data-swiper-slide-index") === "".concat(t.realIndex);
        })[0];
        _r11 = s.slides.indexOf(_e53), _o7 = t.activeIndex > t.previousIndex ? "next" : "prev";
          ...
          if (r.freeMode.momentum) {
            if (d.velocities.length > 1) {
              var _e54 = d.velocities.pop(),
                ...
                _a20 = _e54.position - _s34.position,
                _i14 = _e54.time - _s34.time;
              t.velocity = _a20 / _i14, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i14 > 150 || now() - _e54.time > 300) && (t.velocity = 0);
            } else t.velocity = 0;
            t.velocity *= r.freeMode.momentumVelocityRatio, d.velocities.length = 0;
            var _e55 = 1e3 * r.freeMode.momentumRatio;
            var _s35 = t.velocity * _e55;
            ...
            if (_c3 < t.maxTranslate()) r.freeMode.momentumBounce ? (_c3 + t.maxTranslate() < -m && (_c3 = t.maxTranslate() - m), p = t.maxTranslate(), u = !0, d.allowMomentumBounce = !0) : _c3 = t.maxTranslate(), r.loop && r.centeredSlides && (f = !0);else if (_c3 > t.minTranslate()) r.freeMode.momentumBounce ? (_c3 - t.minTranslate() > m && (_c3 = t.minTranslate() + m), p = t.minTranslate(), u = !0, d.allowMomentumBounce = !0) : _c3 = t.minTranslate(), r.loop && r.centeredSlides && (f = !0);else if (r.freeMode.sticky) {
              ...
              _c3 = Math.abs(o[_e56] - _c3) < Math.abs(o[_e56 - 1] - _c3) || "next" === t.swipeDirection ? o[_e56] : o[_e56 - 1], _c3 = -_c3;
            }
            if (f && i("transitionEnd", function () {
              t.loopFix();
            }), 0 !== t.velocity) {
              if (_e55 = l ? Math.abs((-_c3 - t.translate) / t.velocity) : Math.abs((_c3 - t.translate) / t.velocity), r.freeMode.sticky) {
                var _s36 = Math.abs((l ? -_c3 : _c3) - t.translate),
                  _a21 = t.slidesSizesGrid[t.activeIndex];
                _e55 = _s36 < _a21 ? r.speed : _s36 < 2 * _a21 ? 1.5 * r.speed : 2.5 * r.speed;
              }
            } else if (r.freeMode.sticky) return void t.slideToClosest();
            r.freeMode.momentumBounce && u ? (t.updateProgress(p), t.setTransition(_e55), t.setTranslate(_c3), t.transitionStart(!0, t.swipeDirection), t.animating = !0, elementTransitionEnd(n, function () {
              t && !t.destroyed && d.allowMomentumBounce && (a("momentumBounce"), t.setTransition(r.speed), setTimeout(function () {
                t.setTranslate(p), elementTransitionEnd(n, function () {
                  t && !t.destroyed && t.transitionEnd();
                });
              }, 0));
            })) : t.velocity ? (a("_freeModeNoMomentumRelease"), t.updateProgress(_c3), t.setTransition(_e55), t.setTranslate(_c3), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, elementTransitionEnd(n, function () {
              t && !t.destroyed && t.transitionEnd();
    ...
    updateWrapperSize: function updateWrapperSize(e, s, a) {
      ...
      if (i.virtualSize = (e + o) * t, i.virtualSize = Math.ceil(i.virtualSize / d) - o, i.wrapperEl.style[a("width")] = "".concat(i.virtualSize + o, "px"), r) {
        ...
        for (var _t38 = 0; _t38 < s.length; _t38 += 1) {
          var _a23 = s[_t38];
          l && (_a23 = Math.floor(_a23)), s[_t38] < i.virtualSize + s[0] && _e57.push(_a23);
        }
        s.splice(0, s.length), s.push.apply(s, _e57);
      }
    }
  };
}
...
function addSlide(e, t) {
  ...
  for (var _t43 = l - 1; _t43 >= e; _t43 -= 1) {
    var _e58 = s.slides[_t43];
    _e58.remove(), d.unshift(_e58);
  }
  if ("object" == _typeof(t) && "length" in t) {
    for (var _e59 = 0; _e59 < t.length; _e59 += 1) t[_e59] && r.append(t[_e59]);
    o = n > e ? n + t.length : n;
  } else r.append(t);
  for (var _e60 = 0; _e60 < d.length; _e60 += 1) r.append(d[_e60]);
  ...
  effectInit({
    ...
    setTranslate: function setTranslate() {
      ...
      for (var _a24 = 0; _a24 < e.length; _a24 += 1) {
        var _e62 = t.slides[_a24];
        var i = -_e62.swiperSlideOffset;
        t.params.virtualTranslate || (i -= t.translate);
        var r = 0;
        t.isHorizontal() || (r = i, i = 0);
        var n = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(_e62.progress), 0) : 1 + Math.min(Math.max(_e62.progress, -1), 0),
          l = effectTarget(s, _e62);
  ...
  effectInit({
    ...
    setTranslate: function setTranslate() {
      ...
      for (var _e63 = 0; _e63 < a.length; _e63 += 1) {
        ...
        var _r12 = 90 * _s40,
          _n6 = Math.floor(_r12 / 360);
        l && (_r12 = -_r12, _n6 = Math.floor(-_r12 / 360));
        var _d4 = Math.max(Math.min(_t44.progress, 1), -1);
        var _m = 0,
          _h = 0,
          g = 0;
        _s40 % 4 == 0 ? (_m = 4 * -_n6 * o, g = 0) : (_s40 - 1) % 4 == 0 ? (_m = 0, g = 4 * -_n6 * o) : (_s40 - 2) % 4 == 0 ? (_m = o + 4 * _n6 * o, g = o) : (_s40 - 3) % 4 == 0 && (_m = -o, g = 3 * o + 4 * o * _n6), l && (_m = -_m), p || (_h = _m, _m = 0);
        var v = "rotateX(".concat(p ? 0 : -_r12, "deg) rotateY(").concat(p ? _r12 : 0, "deg) translate3d(").concat(_m, "px, ").concat(_h, "px, ").concat(g, "px)");
        _d4 <= 1 && _d4 > -1 && (f = 90 * _s40 + 90 * _d4, l && (f = 90 * -_s40 - 90 * _d4)), _t44.style.transform = v, c.slideShadows && i(_t44, _d4, p);
      }
      if (s.style.transformOrigin = "50% 50% -".concat(o / 2, "px"), s.style["-webkit-transform-origin"] = "50% 50% -".concat(o / 2, "px"), c.shadow) if (p) m.style.transform = "translate3d(0px, ".concat(r / 2 + c.shadowOffset, "px, ").concat(-r / 2, "px) rotateX(90deg) rotateZ(0deg) scale(").concat(c.shadowScale, ")");else {
        var _e64 = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90),
    ...
    setTranslate: function setTranslate() {
      ...
      for (var _e65 = 0, _t47 = a.length; _e65 < _t47; _e65 += 1) {
        ...
        if (effectTarget(r, _t48).style.transform = b, _t48.style.zIndex = 1 - Math.abs(Math.round(p)), r.slideShadows) {
          ...
          _e66 || (_e66 = createShadow(r, _t48, n ? "left" : "top")), _s43 || (_s43 = createShadow(r, _t48, n ? "right" : "bottom")), _e66 && (_e66.style.opacity = p > 0 ? p : 0), _s43 && (_s43.style.opacity = -p > 0 ? -p : 0);
        }
      }
    },
    setTransition: function setTransition(e) {
    ...
    setTranslate: function setTranslate() {
      ...
      var _loop = function _loop() {
        ...
        if (f && h.shadow || !f) {
          ...
          if (!_e68 && h.shadow && (_e68 = createShadow(r, a)), _e68) {
    ...
    setTranslate: function setTranslate() {
      ...
      for (var l = 0; l < e.length; l += 1) {
        ...
        if (b || y) {
          ...
          g += -28 * c * _e69, h += -.5 * _e69, v += 96 * _e69, m = -25 * _e69 * Math.abs(c) + "%";
        }
        ...
        if (a.slideShadows) {
          var _e71 = o.querySelector(".swiper-slide-shadow");
          _e71 || (_e71 = createShadow(a, o)), _e71 && (_e71.style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1));
        }
